module.exports = {
  ...
  orderConfirmationNotes: [
    '1. TUANA SHALL NOT BE HELD RESPONSIBLE FOR ANY DELAYS CAUSED BY THIRD-PARTY FORWARDERS OR TRANSPORTERS.',
    '2. ALL ORDER REQUESTS MUST BE SUBMITTED VIA EMAIL TO THE DESIGNATED CONTACT PERSON FROM THE TUANA TEAM.',
    '3. FOR ORDERS WITH A TOTAL VOLUME BELOW 1,000 METERS, TUANA WILL APPLY A CHARGE OF APPROXIMATELY €150 FOR THE PREPARATION',
    '    OF THE ATR DOCUMENT, ONLY IF THE CLIENT REQUESTS SUCH DOCUMENTATION. FOR ORDERS EXCEEDING 1,000 METERS,',
    '    THIS COST WILL BE COVERED BY TUANA.',
    '4. CANCELLATION REQUESTS WILL NOT BE ACCEPTED IF SUBMITTED MORE THAN 48 HOURS AFTER ORDER CONFIRMATION, BASED ON THE',
    '    CLIENT\'S LOCAL TIME. IN SUCH CASES, TUANA RESERVES THE RIGHT TO INVOICE THE FULL AMOUNT OF THE ORDER.',
