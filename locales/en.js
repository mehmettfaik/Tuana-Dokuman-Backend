module.exports = {
  ...
  vatTax: 'VAT',
  vat: 'VAT',
  generalTotalVatIncluded: 'GENERAL TOTAL',
  ...
  orderConfirmationNotes: [
    '1. TUANA SHALL NOT BE HELD LIABLE FOR ANY DELAYS RESULTING FROM THIRD-PARTY FREIGHT FORWARDERS OR TRANSPORT COMPANIES.',
    '2. ALL ORDER REQUESTS MUST BE SUBMITTED BY EMAIL TO THE DESIGNATED TUANA CONTACT PERSON.',
    '3. FOR ORDERS TOTALING LESS THAN 1,000 METERS, A FEE OF APPROXIMATELY 150€ WILL BE CHARGED FOR THE',
    '   ATR (FOR ORDERS TO BE DELIVERED IN THE EU) OR EUROMED (FOR ORDERS TO BE DELIVERED PREPARATION OF IN MOROCCO,',
    '   ALGERIA, TUNISIA, EGYPT, NORTHERN MACEDONIA, ALBANIA AND BOSNIA-HERZEGOVINA) BUT ONLY IF THE CLIENT SPECIFICALLY',
    '   REQUESTS IT. FOR ORDERS EXCEEDING 1,000 METERS, THIS COST WILL BE COVERED BY TUANA.',
    '4. ORDER CANCELLATIONS WILL NOT BE ACCEPTED IF REQUESTED MORE THAN 48 HOURS AFTER THE ORDER CONFIRMATION, BASED ON',
    '   THE CLIENT’S LOCAL TIME. IN SUCH CASES, TUANA RESERVES THE RIGHT TO INVOICE THE FULL ORDER AMOUNT.',
    '5. ANY QUALITY CLAIMS MUST BE SUBMITTED BY EMAIL WITHIN 14 CALENDAR DAYS OF RECEIVING THE GOODS, INCLUDING SUPPORTING ',
    '   PHOTOS AND A DETAILED DESCRIPTION. CLAIMS WILL NOT BE ACCEPTED ONCE THE FABRIC HAS BEEN CUT OR PROCESSED.', 
    '6. THIS AGREEMENT IS GOVERNED BY THE LAWS OF THE REPUBLIC OF TURKEY. ANY DISPUTE ARISING FROM THIS ORDER',
    '  SHALL BE SETTLED BY ARBITRATION UNDER THE ICC RULES, IN A NEUTRAL LOCATION MUTUALLY AGREED UPON BY BOTH PARTIES.',
